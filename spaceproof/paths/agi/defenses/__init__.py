...
RECEIPT_SCHEMA = {
    ...
    "receipt_types": [
        "agi_adversarial_integrate",
        "agi_alignment_stress",
        "agi_fractal_encrypt_integrate",
        "agi_side_channel_stress",
        "agi_randomized_integrate",
        "agi_timing_stress",
        "agi_quantum_integrate",
        "agi_spectre_stress",
        "agi_enclave_integrate",
        "agi_btb_stress",
    ],
    "version": "1.0.0",
}
