...
class TestD8Spec:
    ...
    def test_d8_spec_loads(self):
        ...
        from spaceproof.fractal_layers import get_d8_spec
    ...
    def test_d8_alpha_floor(self):
        ...
        from spaceproof.fractal_layers import d8_recursive_fractal
    ...
    def test_d8_uplift_value(self):
        ...
        from spaceproof.fractal_layers import get_d8_uplift
...
class TestSyncConfig:
    ...
    def test_sync_config_loads(self):
        """Sync config valid."""
        from spaceproof.multi_planet_sync import load_sync_config
    ...
    def test_sync_efficiency_threshold(self):
        ...
        from spaceproof.multi_planet_sync import run_sync_cycle, RESOURCE_SHARE_EFFICIENCY
...
class TestD8MultiSync:
    ...
    def test_d8_multi_sync_alpha(self):
        ...
        from spaceproof.multi_planet_sync import d8_multi_sync
...
class TestSyncCycle:
    ...
    def test_sync_cycle_success(self):
        ...
        from spaceproof.multi_planet_sync import run_sync_cycle
...
class TestD8Push:
    ...
    def test_d8_push_floor_met(self):
        ...
        from spaceproof.fractal_layers import d8_push
...
class TestD8Constants:
    ...
    def test_d8_alpha_floor_constant(self):
        ...
        from spaceproof.fractal_layers import D8_ALPHA_FLOOR

        assert D8_ALPHA_FLOOR == 3.43

    def test_d8_alpha_target_constant(self):
        """D8 alpha target is 3.45."""
        from spaceproof.fractal_layers import D8_ALPHA_TARGET

        assert D8_ALPHA_TARGET == 3.45

    def test_d8_uplift_constant(self):
        """D8 uplift is 0.22."""
        from spaceproof.fractal_layers import D8_UPLIFT
...
class TestAtacamaConfig:
    ...
    def test_atacama_solar_flux(self):
        ...
        from spaceproof.atacama_validation import ATACAMA_SOLAR_FLUX_W_M2

        assert ATACAMA_SOLAR_FLUX_W_M2 == 1000

    def test_mars_solar_flux(self):
        """Mars solar flux is 590 W/m^2."""
        from spaceproof.atacama_validation import MARS_SOLAR_FLUX_W_M2

        assert MARS_SOLAR_FLUX_W_M2 == 590

    def test_perovskite_efficiency(self):
        """Perovskite efficiency is 25.6%."""
        from spaceproof.atacama_validation import ATACAMA_PEROVSKITE_EFFICIENCY
